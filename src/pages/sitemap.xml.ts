...
const STATIC_PAGES: { loc: string; lastmod: string }[] = [
  ...
  { loc: '/locations/', lastmod: '2026-08-10' },
  { loc: '/locations/maryland/', lastmod: '2026-08-10' },
  { loc: '/locations/hagerstown-md/', lastmod: '2026-08-10' },
  { loc: '/locations/montgomery-county-md/', lastmod: '2026-08-10' },
  { loc: '/locations/baltimore-md/', lastmod: '2026-08-10' },
  { loc: '/locations/martinsburg-wv/', lastmod: '2026-08-10' },
  { loc: '/about/', lastmod: '2026-08-05' },
  { loc: '/about-steven/', lastmod: '2026-08-05' },
  { loc: '/impact/', lastmod: '2026-08-07' },
